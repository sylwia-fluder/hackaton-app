                    ...
                    <div className="card-shadow row no-gutters ">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                <h4 className="card-title text-center ">Project TITLE <span
                                    className="neutral">12</span>
                                ...
                                <p className="card-text"><span className="card-bold">PROJECT MANAGER:</span> XXXXXXXXXXX
                                </p>
                        ...
                        <div className="card-notification col-md-1 text-center my-auto py-2">
                            <svg className="py-2" width="35" height="39" viewBox="0 0 35 39" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <svg className="svg-tile " width="35" height="39" viewBox="0 0 35 39" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
