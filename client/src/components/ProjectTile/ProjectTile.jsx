...
class ProjectTile extends React.Component {
    ...
    render () {
        ...
        // const cardStyles = classNames(style.card, "mb-2", "rounded", "col-sm-9", "d-flex", "justify-content-center", "mx-auto");
        // const notificationStyles = classNames(style.card-notification, "col-md-1", "text-center", "my-auto");
        ...
        return (
            ...
            <div className="card col-sm-9 ">
                    <div className="card-shadow row no-gutters col-8">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                <h4 className="card-title text-center ">Project TITLE <span className="neutral">12</span> <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6 7C7.89375 7 9.42857 5.4332 9.42857 3.5C9.42857 1.5668 7.89375 0 6 0C4.10625 0 2.57143 1.5668 2.57143 3.5C2.57143 5.4332 4.10625 7 6 7ZM8.4 7.875H7.95268C7.35804 8.15391 6.69643 8.3125 6 8.3125C5.30357 8.3125 4.64464 8.15391 4.04732 7.875H3.6C1.6125 7.875 0 9.52109 0 11.55V12.6875C0 13.4121 0.575893 14 1.28571 14H10.7143C11.4241 14 12 13.4121 12 12.6875V11.55C12 9.52109 10.3875 7.875 8.4 7.875Z" fill="#6CF1B1"/>
                                ...
                                <p className="card-text"><span className="card-bold">PROJECT MANAGER:</span> XXXXXXXXXXX</p>
                                <p className="card-text"><span className="card-bold">ACTIVE FROM: </span> 12/12/2012</p>
                                <p className="card-text"><span className="card-bold">ACTUAL SPRINT:</span> 7</p>
                            </div>
                        </div>
